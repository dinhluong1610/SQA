...
<html>
    ...
    <%
        ArrayList<Baocao> b= (new BaocaoDAO()).getBaocao();
        
        
    %>
    <body>
    <h2> Báo cáo tiền bảo hiểm xã hội 1 lần </h2>
        ...
        <th style="border: 1px solid black; padding:0 15px 0 15px;">Tiền BHXH 1 lần(đơn vị: đồng)</th>
        </tr>     
        <%
            if(b!=null)
